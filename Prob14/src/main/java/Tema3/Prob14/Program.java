...
public class Program extends Emisiune {
	...
	public Program(Emisiune[] emisiuni, String tipProgram, int durataMedie, int emisiuniLive, int emisiuniInregistrate,
			String publicTinta, int oraPreponderentaEmisiune) {
